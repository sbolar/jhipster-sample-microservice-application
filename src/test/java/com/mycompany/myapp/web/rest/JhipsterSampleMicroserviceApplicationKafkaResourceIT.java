...
class JhipsterSampleMicroserviceApplicationKafkaResourceIT {
    ...
    void setup() {
        ...
        JhipsterSampleMicroserviceApplicationKafkaResource kafkaResource = new JhipsterSampleMicroserviceApplicationKafkaResource(kafkaProperties);
    ...
    void producesMessages() throws Exception {
        restMockMvc.perform(post("/api/jhipster-sample-microservice-application-kafka/publish/topic-produce?message=value-produce"))
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc.perform(get("/api/jhipster-sample-microservice-application-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
