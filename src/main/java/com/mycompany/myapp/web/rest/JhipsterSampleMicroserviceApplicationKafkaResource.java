...
@RestController
@RequestMapping("/api/jhipster-sample-microservice-application-kafka")
public class JhipsterSampleMicroserviceApplicationKafkaResource {
    ...
    public JhipsterSampleMicroserviceApplicationKafkaResource(KafkaProperties kafkaProperties) {
